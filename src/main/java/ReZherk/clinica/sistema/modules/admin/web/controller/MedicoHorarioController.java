...
public class MedicoHorarioController {
  ...
  public ResponseEntity<ApiResponse<Page<MedicoConHorariosResponseDto>>> buscarMedicosSinHorarios(
      @Parameter(description = "Nombre o apellido del médico") @RequestParam(required = false) String nombre,
    ...
    log.info(
        "GET /api/admin/medico-horarios/sin-horarios - Filtros: nombre={}, dni={}, cmp={}, especialidad={}, page={}, size={}, sortBy={},sortDirection={}",
        nombre, dni, cmp, especialidad, page, size, sortBy, sortDirection);
    ...
    Page<MedicoConHorariosResponseDto> response = medicoHorarioService.buscarMedicosSinHorarios(nombre, dni, cmp,
        especialidad, pageable);
