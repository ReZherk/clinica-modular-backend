...
public interface CitaRepository extends JpaRepository<Cita, Integer> {
        ...
        @Query(value = "CALL sp_listar_citas(:p_cmp_medico, :p_dni_medico, :p_nombre_medico, " +
                        ":p_id_especialidad, :p_estado, :p_fecha, :p_fecha_inicio, :p_fecha_fin, " +
                        ":p_page, :p_size)", nativeQuery = true)
        List<CitaListadoResult> listarCitasConFiltros(
                        @Param("p_cmp_medico") String cmpMedico,
                        @Param("p_dni_medico") String dniMedico,
                        @Param("p_nombre_medico") String nombreMedico,
