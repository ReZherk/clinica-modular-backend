-- V28__fix_cita_hora_inicio_fin.sql
...
CREATE PROCEDURE sp_listar_citas(
    IN p_cmp_medico VARCHAR(20),           -- Busca por CMP del medico
    IN p_dni_medico VARCHAR(12),           -- Busca por DNI del medico
    IN p_nombre_medico VARCHAR(100),       -- Busca por Nombre completo del medico
