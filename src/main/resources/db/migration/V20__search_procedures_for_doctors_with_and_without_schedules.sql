...
-- Descripción: Creación de procedimientos almacenados para búsqueda de médicos con y sin horarios asignados.
-- Autor: ReZherk
-- Fecha: 2025-10-31
-- Dependencia: Requiere tablas de la migración V19 (horario, medico_horario, cita)
-- =============================================

-- =============================================
-- Procedimiento: sp_buscar_medicos_con_horarios
-- Descripción: Busca médicos que tienen horarios asignados con filtros y paginación.
-- =============================================
DELIMITER $$
...
-- =============================================
-- Procedimiento: sp_buscar_medicos_sin_horarios
-- Descripción: Busca médicos que NO tienen horarios asignados con filtros y paginación.
-- =============================================
DELIMITER $$
